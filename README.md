...
A RESTful API built with **JAX-RS ** and an embedded **Grizzly HTTP server**, implementing full room and sensor management for the University of Westminster's Smart Campus initiative.
